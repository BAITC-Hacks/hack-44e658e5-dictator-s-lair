...
Архитектура рассчитана на русскую, казахскую и смешанную RU–KZ речь. **Сквозная работа подтверждена на русском.** Поддержка казахских и смешанных конструкций расширяется; её подтверждение отдельными регрессионными тестами ещё предстоит. Текстовые тесты извлечения не заменяют benchmark распознавания на реальном аудио.
...
- Казахский STT и смешанная речь ещё не подтверждены отдельным аудиобенчмарком.
